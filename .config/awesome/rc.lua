...
beautiful.get().wallpaper = "/home/lukas/Dropbox/wallpaper.jpg"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    --s.mywibox = awful.wibar({ position = "left", width="20", orientation = "north" })
...
-- control volume and display brightness
...
-- tag ]
	...
	function ()
         if client.focus then
              local tag = client.focus.screen.tags[13]
              if tag then
                  client.focus:move_to_tag(tag)
              end
         end
